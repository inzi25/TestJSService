...
public class DepartmentService {
	...
	public String getDepartment() {
		...
		try {
			...
			String SQL = "SELECT * FROM sgit.departments";
			...
			while (rs.next()) {
				...
				Department h1 = new Department(rs.getString(1),
	...
	public String insertDepartment(Department department) {
		...
		try {
			...
			System.out.print("Connected.<br/>");
			String SQL = "INSERT INTO sgit.departments (department_id,department_name,department_active) VALUES ('"
					+ department.getId()
					+ "','"
					+ department.getName()
					+ "','"
	...
	public String updateDepartment(Department department) {
		...
		try {
			...
			con = DriverManager.getConnection(connectionUrl);
			System.out.print("Connected.<br/>");
			String SQL = "UPDATE sgit.departments SET department_name= " + " '"
					+ department.getName() + "'" + "," + "department_active="
					+ "'" + department.getActive() + "'"
			...
			if (res == 1) {
				...
				result = "DepartmentResource updated successfully";
			}
		}
